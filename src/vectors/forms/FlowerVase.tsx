  ...
  return (
    ...
    >
      <ellipse
        ...
        rx="22.1722"
        ry="6.74036"
        fill="url(#paint0_linear_378_557)"
      />
      ...
      />
      <path
        d="M153.899 246.949C141.749 247.849 140.849 248.749 139.949 260.899C139.049 248.749 138.149 247.849 126 246.949C138.149 246.049 139.049 245.149 139.949 233C140.849 245.149 141.749 246.049 153.899 246.949Z"
        fill="white"
      />
      <path
        d="M243.655 193.87C233.316 194.636 232.551 195.402 231.785 205.741C231.019 195.402 230.253 194.636 219.914 193.87C230.253 193.105 231.019 192.339 231.785 182C232.551 192.339 233.316 193.105 243.655 193.87Z"
        fill="white"
      />
      <path
        d="M263 217.612C249.598 218.605 248.605 219.597 247.613 233C246.62 219.597 245.627 218.605 232.225 217.612C245.627 216.619 246.62 215.626 247.613 202.224C248.605 215.626 249.598 216.619 263 217.612Z"
        fill="white"
      />
      <path
        d="M176.776 123.388C163.373 124.38 162.381 125.373 161.388 138.776C160.395 125.373 159.402 124.38 146 123.388C159.402 122.395 160.395 121.402 161.388 108C162.381 121.402 163.373 122.395 176.776 123.388Z"
        fill="white"
      />
      <path
      ...
      <path
        ...
        fill="url(#paint4_linear_378_557)"
      />
      <g filter="url(#filter1_d_378_557)">
        <path
          d="M132.029 332.443C131.925 332.187 131.633 332.065 131.377 332.169C131.122 332.274 130.999 332.566 131.104 332.821L132.029 332.443ZM131.104 332.821C133.486 338.644 135.791 342.417 137.707 346.098C139.622 349.775 141.181 353.412 142.135 359.053L143.121 358.887C142.145 353.115 140.543 349.377 138.594 345.636C136.648 341.898 134.388 338.209 132.029 332.443L131.104 332.821Z"
          fill="#0C453E"
        />
      </g>
      <path
        d="M173.883 274.863C170.196 273.459 164.226 282.062 164.226 282.062L167.562 291.016L177.57 285.749C177.57 285.749 177.57 276.268 173.883 274.863Z"
        fill="url(#paint5_linear_378_557)"
      />
      <path
        d="M169.398 288.465C157.787 295.022 153.891 308.009 158.961 311.755C164.031 315.5 173.793 310.885 180.765 301.447C184.487 296.408 185.521 284.074 182.549 281.005C177.479 277.26 178.061 283.573 169.398 288.465Z"
        fill="url(#paint6_linear_378_557)"
      />
      <path
        d="M167.976 287.781C170.993 300.769 164.057 312.419 157.869 311.215C151.682 310.011 148.484 299.697 150.726 288.18C151.922 282.031 160.312 272.931 164.583 273.046C170.77 274.251 165.724 278.089 167.976 287.781Z"
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_378_557"
            result="shape"
          />
        </filter>
        <filter
          id="filter1_d_378_557"
          x="126.85"
          y="332.132"
          width="20.4868"
          height="35.354"
