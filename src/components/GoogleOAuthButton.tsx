...
const GoogleOAuthButton = () => {
  ...
  return (
    <div className="to-72% flex items-center justify-center space-x-3 rounded-full bg-gradient-to-b from-white to-white py-3 shadow-xl hover:opacity-75 sm:px-5 md:px-14 md:py-5 md:text-xl">
